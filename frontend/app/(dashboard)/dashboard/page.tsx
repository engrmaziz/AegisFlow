...
export default function DashboardOverview() {
    ...
    const handleDownloadReport = async () => {
        ...
        try {
            ...
            pdf.setFontSize(18);
            pdf.text("Financial Overview Report", margin, 20);
            ...
            // Chart/Cards Image
            pdf.addImage(imgData, 'PNG', margin, 35, contentWidth, Math.min(contentHeight, pdfHeight - 50));
            ...
            for (let i = 1; i <= pageCount; i++) {
                ...
                pdf.text('Report generated by InvoiceIQ — https://iq-invoice.vercel.app/', margin, pdfHeight - 10);
            }
